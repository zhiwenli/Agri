...
def object_packet(sat_name,sat_mission_date,line2,cartesian_data):
   ...
   +"</p><p>Satus: In operation</p>"+"</p> <p>Orbit: MEO"+"</p><p>Owner: Russia</p>"\
   +"<p>Mission date: "+sat_mission_date+"</p>"
    ...
    "model": {
        "gltf" : "/data/permanent/satellite_glb_model/GLONASS.glb",
        "scale" : 1,
        "minimumPixelSize": 30
    },
	"billboard":
     {
      ...
      "image":"/public/img/GLONASSbillboard.png"
    },
	  "label":{
...
def readTLEfile():
    ...
    linelist = open(CurrentPath+"/GLONASS_TLE.txt",'r').readlines()
    #删除重复的 卫星名，每两行表示一颗碎片
