...
FP::putLog($client.' 访问pc版'.' (IP: '.$ip.' City: '.$city.' OS: '.GetOs().' Browser kernel: '.GetBrowser().')');
?>
...
<body>
  ...
  <div id="cesiumContainer">
    ...
    <p class="copyright-text" ondblclick="setCookie('role', 'admin');"><big></b><big>©</big></big> 北斗农业·中国 滇ICP备15000913号-5</p>
  ...
  <script type="text/javascript" src="/public/javascripts/p-index.js"></script>
